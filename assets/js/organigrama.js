(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (img) {
      ...
      btn.type = 'button';
      btn.className = 'button btn btn-primary mt-3 org-image-open';
      ...
      overlay.innerHTML =
        '<div class="org-lightbox-inner">' +
          '<div class="org-lightbox-toolbar">' +
            '<button type="button" class="org-zoom-out" aria-label="Allunyar">−</button>' +
            '<button type="button" class="org-zoom-reset" aria-label="Reset zoom">100%</button>' +
            '<button type="button" class="org-zoom-in" aria-label="Apropar">+</button>' +
